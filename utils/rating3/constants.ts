...
export const WEAPON_VALUES: Record<string, number> = {
    // Pistols
    'glock': 200 * 1.25, 'hkp2000': 200, 'usp_silencer': 200, 'p250': 300,
    'cz75a': 600, 'tec9': 500 * 1.25, 'fiveseven': 500, 'deagle': 700, 'revolver': 600, 'elite': 300,
    
    // SMGs
    'mac10': 1050 * 1.25, 'mp9': 1250, 'ump45': 1200, 
    ...
    'm4a4': 2900, 
    'm4a1_silencer': 2900,
    'ssg08': 1700, 'awp': 4750, 'aug': 3300, 'sg553': 3000 * 1.25, 'scar20': 5000, 'g3sg1': 5000 * 1.25,
    
    // Heavy
    'nova': 1050, 'xm1014': 2000, 'sawedoff': 1100 * 1.25, 'mag7': 1300, 'm249': 5200, 'negev': 1700,
    
    // Equipment
    'flashbang': 200, 'smokegrenade': 300, 'hegrenade': 300, 'molotov': 400 * 1.25, 
