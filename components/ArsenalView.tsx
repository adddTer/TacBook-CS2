...
export const ArsenalView: React.FC = () => {
  ...
  return (
    <div className="space-y-0 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-12">
      ...
      <section className="bg-linear-to-br from-neutral-100 to-neutral-200 dark:from-neutral-900 dark:to-neutral-950 -mx-4 px-4 py-4 border-b border-neutral-200 dark:border-neutral-800">
