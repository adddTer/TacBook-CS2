...
import { calculateTenure } from '../../utils/rosterHelpers';
    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {playerStats.map(player => {
                const tenure = useMemo(() => calculateTenure(player.id), [player.id]);
                ...
                return (
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <div className="flex items-center gap-2 mb-0.5">
                                    ...
                                    <span className="text-[10px] font-bold px-1.5 py-0.5 bg-neutral-100 dark:bg-neutral-800 text-neutral-400 dark:text-neutral-500 rounded border border-neutral-200 dark:border-neutral-700">
                                        {tenure}
                                    </span>
                                </div>
                        ...
                        <div className="flex flex-col items-end gap-1">
                            <div className="text-[10px] font-bold text-neutral-400 uppercase tracking-wider">评分</div>
