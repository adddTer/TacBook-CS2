...
export const mirageTactics: Tactic[] = [
  {
    ...
    actions: [
      ...
      { id: generateId('a'), time: "1:50", who: "道具辅助", content: "在出生点/下水道口附近投掷拱门慢烟。", type: 'utility', utilityId: '200001' },
      { id: generateId('b'), time: "1:50", who: "自由人", content: "投掷VIP慢烟，封锁VIP视野。", type: 'utility', utilityId: '200002' },
      ...
      { id: generateId('e'), time: "1:35", who: "自由人", content: "给B小自助闪光，尝试与狙击手控制B小。", type: 'utility', utilityId: '200003' },
      { id: generateId('f'), time: "1:35", who: "道具辅助", content: "看到中路动作后，给B二楼闪光弹，掩护队友出二楼。", type: 'utility', utilityId: '200004' },
  ...
  },
  {
    ...
    actions: [
      ...
      { id: generateId('a'), time: "1:50", who: "道具辅助", content: "在出生点/下水道口附近投掷拱门慢烟。", type: 'utility', utilityId: '200001' },
      { id: generateId('b'), time: "1:50", who: "狙击手", content: "投掷VIP慢烟，掩护中路推进。", type: 'utility', utilityId: '200002' },
