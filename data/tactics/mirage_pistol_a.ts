...
export const mirageATactics: Tactic[] = [
  {
    id: "1000003", // Updated to 7 digits
    mapId: "mirage",
    title: "手枪局A区爆弹",
    side: "T",
    site: "A",
    tags: [TAGS.PISTOL, TAGS.EXEC],
    isRecommended: true, // Recommended Tactic
    metadata: {
      author: "addd",
    ...
    actions: [
      ...
      { id: generateId(), time: "1:45", who: "道具辅助", content: "跳投A区过点烟（不漏身位），封锁CT视线。", type: 'utility', utilityId: '2000005' },
      { id: generateId(), time: "1:42", who: "道具辅助", content: "投掷跳台火，覆盖跳台及楼梯下，逼退CT。", type: 'utility', utilityId: '2000006' },
